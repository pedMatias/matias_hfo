...
from models.utils import remove_collisions
import numpy as np
...
class PursuitEnvironmentModel(ReplayMemoryModel, ABC):
    ...
    def update_reward_predictor(self, verbose):
        try:
            ...
            losses, _, accuracies = self.rewards_model.update(X, y, epochs=1, batch_size=self._replay_batch_size, verbose=verbose)
