...
from multi_agents.plastic.plastic_client.behaviour_dist import \
    BehaviourDistClient
...
class PlasticClientPlayer:
    def __init__(self, team_name: str, num_opponents: int, num_teammates: int,
                 models_dir: str, model_type: str, agent_type: str,
        ...
        # Agent instance:
        self.policies_names = config.TEAMS_NAMES
        # Agent instance:
        self.policies = self.load_plastic_policies(
            models_dir,
            team_names=self.policies_names,
            use_webservice=use_webservice
        )
        self.behaviour_dist = BehaviourDistClient(
            policies=self.policies,
            agent_type=agent_type,
            correct_policy=team_name,
    ...
    def _play_episode(self, verbose: bool = False):
        ...
        while self.game_interface.in_game():
            ...
            # Save metrics:
            predicted_policy_name = self.behaviour_dist.get_best_policy_name()
            guessed_teams.append(predicted_policy_name)
    ...
    def play(self, num_episodes: int, verbose: bool = False):
        ...
        metrics_dict["teams"] = self.policies_names.copy()
