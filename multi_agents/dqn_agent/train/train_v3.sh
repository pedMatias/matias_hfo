...
do
  ...
  NUM_EPISODES_LIST=(0 12500 12500 12500 12500 12500 12500 12500 12500 12500 12500 12500 12500 12500 1)
  EPSILONS_LIST=(1. 0.3 0.25 0.2 0.15 0.1 0.1 0.05 0.1 0.3 0.15 0.1 0.1 0.1 0.1)
  STARTING_STEP=8
  for i in {11..11}
  do
    STEP=$i
