...
TRAIN_FILE=$AGENTS_DIR/scripts/train_model/train_model.py

TEAMMATE_NAME="yushan"
DIR_NAME="${MODELS_DIR}/${TEAMMATE_NAME}"
mkdir $DIR_NAME

NUM_TEST_EPISODES=1000
NUM_EPISODES_LIST=(25000 25000 25000 25000 25000)  # 100k espisodes
EPSILONS_LIST=(0.4 0.3 0.1 0.05 0.)
